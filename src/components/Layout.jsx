  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F3F3F3]">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Сайдбар десктоп – ширина w-80 (320px), надпись помещается */}
        <aside className="hidden lg:flex flex-col w-80 bg-[#1F655B] text-white flex-shrink-0">
        ...
        {/* Мобильное меню – та же ширина w-80 */}
        {mobileOpen && (
          <div className="lg:hidden fixed inset-0 z-20">
            <div className="absolute inset-0 bg-black/30" onClick={() => setMobileOpen(false)} />
            <div className="absolute left-0 top-0 bottom-0 w-80 bg-[#1F655B] text-white shadow-lg overflow-y-auto">
              <div className="px-5 py-6">
        ...
        {/* Основной контент – min-w-0 позволяет сжиматься */}
        <main className="flex-1 min-w-0 overflow-auto lg:pt-[18px] px-5 pb-8 pt-16 lg:pt-0">
          <Outlet />
        </main>
      </div>
    </div>
